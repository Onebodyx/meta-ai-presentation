...
**Ход соперника**, **числовые и шахматные оценки** и **список кандидатов для показа** исходят только из **Stockfish**. Легальность **введённого** хода в UI проверяется **python-chess** (не LLM и не эвристики интерфейса). Модель **LLM** получает **уже подготовленное описание** посчитанных линий (ходы, оценки, при необходимости краткая нотация продолжения) и лишь **переводит** это в связный текст: идеи, типичные мотивы, сравнение вариантов — **без изобретения альтернативных ходов** и без пересчёта позиции.
